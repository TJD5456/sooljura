...
<div class="main-container">
    ...
    <div class="service_cont">
        ...
        <p>제1조(목적) 이 약관은 "술주라"(이하 "몰")에서 제공하는 인터넷 관련 서비스(이하 "서비스")를 이용함에
            있어 "몰"과 이용자의 권리와 의무를 규정함을 목적으로 합니다.</p><br>
        ...
        <p>4. "비회원"이란 회원가입 없이 서비스를 이용하는 자를 말합니다.</p><br>
        ...
        <p>3. 변경된 약관에 동의하지 않을 경우, 이용자는 회원탈퇴를 요청할 수 있습니다.</p><br>

        <h4>제4조(서비스의 제공)</h4>
        <p>1. "몰"은 다음과 같은 서비스를 제공합니다: 음주 게임 및 커뮤니티 콘텐츠 제공, 회원 간 소통 및 정보
            공유</p>
        <p>2. "몰"은 서비스의 품질을 유지하기 위해 지속적으로 노력합니다.</p><br>

        <h4>제5조(회원가입 및 탈퇴)</h4>
        <p>1. 이용자는 회원가입 절차를 통해 "몰"의 회원으로 등록할 수 있습니다.</p>
        <p>2. 회원은 언제든지 회원탈퇴를 요청할 수 있으며, "몰"은 이를 즉시 처리합니다.</p><br>

        <h4>제6조(개인정보보호)</h4>
        <p>1. "몰"은 서비스 제공을 위해 최소한의 개인정보를 수집합니다.</p>
        <p>2. 개인정보는 이용자의 동의 없이 제3자에게 제공되지 않으며, "몰"은 이를 안전하게 관리할 책임이 있습니다.</p><br>

        <h4>제7조(책임과 의무)</h4>
        <p>1. "몰"은 서비스 운영과 관련하여 법령을 준수하며, 안정적인 서비스를 제공하기 위해 노력합니다.</p>
        <p>2. 이용자는 "몰"에서 제공하는 서비스를 불법적으로 사용하거나 타인의 권리를 침해하지 않아야 합니다.</p><br>

        <h4>제8조(분쟁해결 및 관할법원)</h4>
        <p>1. "몰"과 이용자 간에 발생한 분쟁은 성실히 협의하여 해결합니다.</p>
        <p>2. 협의가 어려운 경우, 관할 법원은 "몰"의 본사 소재지를 기준으로 합니다.</p><br>

        <h4>부칙</h4>
        <p>1. 이 약관은 2024년 12월 20일부터 적용됩니다.</p><br>
        <hr>
        <br><br><br><br><br>
    </div>
