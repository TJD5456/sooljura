                ...
                <div class="comment">
                    ...
                    <c:forEach var="comment" items="${comments}">
                        <div class="comment" id="comment-${comment.commentKey}">
                            <div>
                                ...
                                <c:if
                                    ...
                                    <form action="/post/deleteComment.do" method="post"
                                        ...
                                        <button type="submit"
                                                style="border: none; background: none; color: red; cursor: pointer;">삭제
                                        </button>
                                    </form>

                                    <!-- 수정 버튼 -->
                                    <button type="button"
                                            onclick="editComment('${comment.commentKey}', '${fn:escapeXml(comment.commentContent)}');">
                                        수정
                                    </button>
                                </c:if>
                            </div>
                            ...
                            <div class="content"
                                 id="comment-content-${comment.commentKey}">${fn:escapeXml(comment.commentContent)}</div>
                        </div>
                    </c:forEach>
