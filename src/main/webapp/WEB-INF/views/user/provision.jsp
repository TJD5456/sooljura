...
<body>
	...
	<div class="submit-wrap">
        ...
        <br>
        <br>
        <form action="/user/joinFrm.do" id="provision" method="get">
            <input type="checkbox" id="chkAll" name="chkAll" onclick="toggleChkbox()"> 술주라의 모든 약관을 확인하고 동의합니다
            <br><br>
            <input type="checkbox" name="useSite" id="useSite"> 이용약관<br>
            <textarea>전자상거래(인터넷사이버몰) 표준약관
                표준약관 제10023호
                (2015. 6. 26. 개정)
            ...
            <br><br><br>
            <input type="checkbox" name="useInfo" id="useInfo"> 개인정보 수집 및 이용 동의<br>
            <textarea>개인정보 수집 및 활용 동의서
               ...
               한국저작권위원회가 위와 같이 개인정보 필수항목을 수집ㆍ이용하는 것에 동의합니다.   (동의함 □, 동의하지 않음 □)
                 2) 선택항목 : 보훈대상, 장애 관련 사항, 자격사항, 사회경험, 경력사항 등 입사에 필요한 일반 정보
               한국저작권위원회가 위와 같이 개인정보 선택항목을 수집ㆍ이용하는 것에 동의합니다.   (동의함 □, 동의하지 않음 □)
               다. 개인정보의 보유 및 이용 기간
                 o 입사지원자의 개인정보 수집ㆍ이용에 관한 동의일로부터 채용절차 종료 시까지 위 이용목적을 위하여 보유 및 이용하게 됩니다. 단, 채용절차 종료 후에는 고용계약 유지, 민원처리, 분쟁해결 및 법령상 의무이행 등을 위하여 1년간 보유하게 됩니다.
               
               라. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익
                 o 위 개인정보 중 필수정보의 수집ㆍ이용에 관한 동의는 외부공모 진행을 위해 필수적이므로, 위 사항에 동의하셔야만심사 및 근로계약의 체결이 가능합니다.
                 o 지원자는 개인정보의 선택항목 제공 동의를 거부할 권리가 있습니다. 다만, 지원자가 선택항목 동의를 거부하는 경우 원활한 공모 심사를 할 수 없어 공모 접수에 제한을 받을 수 있습니다.
               
                2. 민감정보 수집에 대한 동의 (민감정보 기재시에만 한함)
               가. 수집 및 이용 목적 : 한국저작권위원회 외부공모 심사, 선발시 우대사항 적용 참고 자료
               
               나. 제공하는 개인정보 항목 : 보훈대상, 장애 관련 사항
               
               다. 제공정보의 보유 및 이용 기간 : 1년
               
               라. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익
                 o 지원자는 민감정보 처리에 대한 동의를 거부할 권리가 있습니다. 다만, 지원자가 동의를 거부하는 경우 원활한 공모 심사를 할 수 없어 공모 접수에 제한을 받을 수 있습니다.
               
               한국저작권위원회가 위와 같이 개인정보를 수집ㆍ이용하는 것에 동의합니다.
               (동의함 □, 동의하지 않음 □)
               
                3. 개인정보의 제3자 제공에 대한 동의
               가. 제공 대상 : 한국저작권위원회 외부공모 관련 경력사항에 대한 증명서 발급기관
               
               나. 제공정보의 이용 목적 : 지원자 제출정보의 검증
               
               다. 제공하는 개인정보 항목 : 성명, 경력사항
               
               라. 제공정보의 보유 및 이용 기간 : 1년
                 ※ 개인정보를 제공받는 자는 상기 이용목적 외에 개인정보를 이용할 수 없으며, 개인정보 보호법 등에서 정하는 바에 기록, 보관, 파기됩니다.
               
               마. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익
                 o 지원자는 개인정보 제3자 제공 동의를 거부할 권리가 있습니다. 다만, 지원자가 동의를 거부하는 경우 원활한 공모 심사를 할 수 없어 공모 접수에 제한을 받을 수 있습니다.
               
               한국저작권위원회가 위와 같이 개인정보를 수집ㆍ이용하는 것에 동의합니다.
               (동의함 □, 동의하지 않음 □)
               
                본인은 한국저작권위원회 기획혁신본부장 공모에 지원함에 있어 개인정보 수집･이용･제공에 관한 본 동의서의 내용을 충분히 숙지하였으며, 이에 동의합니다.
            ...
            <div class="btn-group">
                <input type="button" name="previous" id="previous" onclick="previousBtn()" value="이전단계">
                <input type="button" name="next" id="next" onclick="nextBtn()" value="다음단계">
            </div>
        </form>
    </div>
<script>
